        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityBorn = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    CountryBorn = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersActors", x => new { x.UserId, x.ActorId });
                    table.ForeignKey(
